        ...
        <Card>
          ...
          <CardContent className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2 border-t border-border pt-4">
              ...
              {detail.sources.map(({ locator, source }) => {
